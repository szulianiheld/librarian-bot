...
@Component
class SohoMenuRequest(private val facebook: FacebookHelper, private val messages: MessageResolver) : BotCommand {
    ...
    private fun successResponse() = facebook.getFirstPost("CocinaSoho", "Hoy")

    private fun defaultResponse() = messages.get("lunchbot.response.menu.notfound.comerbien")
}
